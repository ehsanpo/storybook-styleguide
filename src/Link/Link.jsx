...
const linkStyles = (props) => css`
  ...
  color: ${props.secondary ? props.secondary.toString() : 'turquoise'};
  ...
  ${props.tertiary &&
  css`
    color: ${tokens.colors.tertiary[500]};

    &:hover {
      color: ${tokens.colors.tertiary[800]};
    }

    &:active {
      color: ${tokens.colors.tertiary[900]};
    }
  `};
